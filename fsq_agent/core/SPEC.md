...
- `harness/_driver_tools.py`: Thin platform declaration compatibility helpers, Android/Web action catalog wiring, and function schema/capability discovery wrappers backed by `capabilities`.
