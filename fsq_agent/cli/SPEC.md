...
- `run`, `init`, and playground startup use `settings.harness.platform` to select readiness validation, registry bootstrap, strict harness construction, and platform-specific error messages.
- Strict replay parses cases against the active platform registry snapshot.
