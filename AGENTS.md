...
Do not treat `AGENTS.md` as the project specification. Implementation must follow confirmed `SPEC.md` files, and completion requires independent diff-based SPEC implementation audit.
