...
from auto_test_agent.agent import AutoTestAgent
from auto_test_agent.cli._formatting import console, print_capabilities, print_result
...
from auto_test_agent.models import AutoTestAgentError
from auto_test_agent.tools import CapabilityRegistry
